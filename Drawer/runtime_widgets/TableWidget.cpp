...
namespace rn {
    ...
    void TableWidget::RenderContent(ImVec2& screen_min, ImVec2& screen_max) {
        ...
        // Îãðàíè÷èâàåì îáëàñòü òàáëèöû
        ImGui::SetNextWindowPos(pos);
        ImGui::SetNextWindowSize(size);

        // Èñïîëüçóåì îêíî áåç çàãîëîâêà äëÿ îãðàíè÷åíèÿ îáëàñòè
        ...
        if (ImGui::BeginChild(("##table_child_" + GetId()).c_str(),
            ...
            // Ïîëó÷àåì äîñòóïíóþ îáëàñòü âíóòðè îêíà
            ...
            if (ImGui::BeginTable(("##table_" + GetId()).c_str(),
                ...
                if (show_headers_) {
                    ImGui::TableSetupScrollFreeze(0, 1); // Çàãîëîâîê ôèêñèðîâàí ïðè ñêðîëëå
                ...
                //    }
                //}
                // Îïðåäåëÿåì ðåàëüíîå êîëè÷åñòâî ñòðîê äëÿ îòîáðàæåíèÿ
